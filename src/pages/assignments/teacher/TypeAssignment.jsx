...
export default function TypeAssignment() {
    ...
    const [assignmentData,setAssignmentData] = useState(()=>JSON.parse(localStorage.getItem('type-assignment-details')))
...
export const MyDocument = ({ content,year,branch,section,semester,subject,title }) => {
  return (
    <Document>
      <Page style={styles.page}>
        ...
        <View style={styles.details}>
          <View>
            <Text>For: {year}-{branch}-{section} Sem:{ semester}(2019) </Text>
          </View>
          <View>
